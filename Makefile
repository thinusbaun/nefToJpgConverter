#############################################################################
# Makefile for building: nefJPGConverter
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  nefJPGConverter.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile nefJPGConverter.pro
#############################################################################
...
Makefile: nefJPGConverter.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/lib/libQt5Gui.prl \
		/lib/libQt5Core.prl
	$(QMAKE) -o Makefile nefJPGConverter.pro
...
dist: 
	@test -d .tmp/nefJPGConverter1.0.0 || mkdir -p .tmp/nefJPGConverter1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/nefJPGConverter1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/nefJPGConverter1.0.0/ && (cd `dirname .tmp/nefJPGConverter1.0.0` && $(TAR) nefJPGConverter1.0.0.tar nefJPGConverter1.0.0 && $(COMPRESS) nefJPGConverter1.0.0.tar) && $(MOVE) `dirname .tmp/nefJPGConverter1.0.0`/nefJPGConverter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/nefJPGConverter1.0.0
